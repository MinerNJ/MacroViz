...
public class DataPointPlotterFats : MonoBehaviour
{
    public string inputFile;

    public GameObject DataPointPrefab;
    public GameObject DataPointHolderFats;
    private List<Dictionary<string, object>> dataPointList;

    public int columnScale = 5;
    public int columnX = 2;
    ...
    private void Start()
    {
        ...
        for (var i = 0; i < dataPointList.Count; i++)
        {
            ...
            dataPoint.transform.parent = DataPointHolderFats.transform;
